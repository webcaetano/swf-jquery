![Bower version](https://badge.fury.io/bo/swf-jquery.svg) [![Build Status](https://travis-ci.org/webcaetano/swf-jquery.svg)](https://travis-ci.org/webcaetano/swf-jquery)
